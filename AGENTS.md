...
Do not claim that the WAV import and playback path was tested unless real WAV files were manually loaded and triggered with both mouse and keyboard in each required browser. Mobile-browser testing is outside the approved M3 scope.
