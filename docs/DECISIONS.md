...
- confirmed wrong, then confirmed fixed, via the user's own real iPhone home screen - not by Claude directly (browser-tool checks only, same limitation this decision already carries elsewhere),
