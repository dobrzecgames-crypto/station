...
export function TransportBar({ bpm, swing, isPlaying, mode, loopSong, onBpmChange, onSwingChange, onModeChange, onLoopSongChange, onPlay, onStop }: TransportBarProps) {
